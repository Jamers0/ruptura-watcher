...
export function ImportDataLocal({ onDataImported }: ImportDataLocalProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Diálogo de Confirmação Inicial */}
      ...
      {/* Diálogo de Aviso sobre Duplicação */}
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="space-y-2">
              <p>
                Confirme que os dados não se encontram duplicados. O envio de dados duplicados poderá comprometer a análise de ruturas.
              </p>
              <p>
                Verifique se a informação já foi enviada anteriormente antes de prosseguir.
              </p>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel>Não (Cancelar Envio)</AlertDialogCancel>
